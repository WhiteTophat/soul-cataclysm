...
@Mod("soulcataclysm")
public class SoulcataclysmMod {
	public static final Logger LOGGER = LogManager.getLogger(SoulcataclysmMod.class);
	public static final String MODID = "soulcataclysm";

	public SoulcataclysmMod() {
